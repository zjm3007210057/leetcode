 ...
 * <p>
 * Created by zjm on 2019/6/20 20:19
 */
public class TeemoAttacking {

    //consider timeSeries[i] and timeSeries[i+1], if timeSeries[i+1] - timeSeries[i] >= duration,
    //which means at time point i, Ashe can be in poisoned status sustained duration time.
    //and if timeSeries[i+1] - timeSeries[i] < duration, which means at time point i,
    //Ashe can only be in poisoned status sustained timeSeries[i+1] - timeSeries[i] time.
